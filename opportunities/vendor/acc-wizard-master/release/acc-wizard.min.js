!(function (t, e, a, n) {
  function s(a, s) {
    ...
    function o() {
      if (s.addButtons)
        for (
          var a = t("<div/>", { class: s.stepClass }).append(
              t("<button/>", {
                class: s.nextClasses,
                id:s.nextId,
                type: s.nextType,
            ...
            l = t("<div/>", { class: s.stepClass }).append(
              t("<button/>", {
                class: s.backClasses,
                type: s.backType,
                text: s.backText,
            ...
            o = t(".panel-collapse .panel-body form", u),
            c = o.length,
            r = 0;
          c > r;
          r++
      ...
      t(".collapse", u).each(function () {
        ...
        s.autoScrolling &&
          t(e).bind("hashchange", function () {
            d !== e.location.hash &&
              ((d = e.location.hash),
              t(".panel-collapse" + d, u).collapse("show"),
              i(d));
          }),
          ...
          (t("." + s.stepClass, u)
            ...
            .click(function (a) {
              ...
              var s =
                ...
                t(
                  ".panel-collapse",
                  t(n).parents(".panel").next(".panel")[0]
                )[0].id;
              t(s).collapse("show"),
                p("onNext", n),
                (d = s),
          ...
          t("." + s.stepClass, u)
            ...
            .click(function (a) {
              ...
              var s =
                ...
                t(
                  ".panel-collapse",
                  t(n).parents(".panel").prev(".panel")[0]
                )[0].id;
              t(s).collapse("show"),
                p("onBack", n),
                (d = s),
    ...
    var d,
      ...
      u = t(a);
    return (
      (s = t.extend({}, t.fn[l].defaults, s)), o(), { option: c, destroy: r }
    );
  }
  var l = "accwizard";
  (t.fn[l] = function (e) {
      ...
      return (
        this.each(function () {
          if (
            ...
            "function" != typeof t.data(this, "plugin_" + l)[i]
          )
            throw new Error("Method " + i + " does not exist on jQuery." + l);
    ...
    return "object" != typeof e && e
      ...
      : this.each(function () {
          t.data(this, "plugin_" + l) ||
            t.data(this, "plugin_" + l, new s(this, e));
        });
  }),
    (t.fn[l].defaults = {
      addButtons: !0,
